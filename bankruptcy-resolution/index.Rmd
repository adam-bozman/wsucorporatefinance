...
## A Chrysler Case Study

> _"Chapter 11 is well-suited to reorganizing a firm's financial side, with the court and the parties sorting out priorities and then bargaining to a settlement.  That's what the 1978 Bankruptcy Code sought to accomplish in a financial world that seemed a simpler one, where all bankruptcy had to do was sort out the financial claims of stockholders and secured and unsecured creditors."_

.pull-right[

Mark J. Roe and David Skeel in [Assessing the Chrysler Bankruptcy](https://pcg.law.harvard.edu/wp-content/uploads/papers/2009fall-Speakers_09-29_Roe.pdf)
...
- This current code completely replaced the former Bankruptcy Act of 1898
 ...
 - While the current code has been amended multiple times since 1978, the core enactment is still used today
...
The indirect bankruptcy costs are the unmeasurable opportunity costs, including: 
...
**"Cram Down"** - If the bankruptcy judge does not believe agreement will be reached, he or she can force acceptance of a plan (negotiation) by using a procedure called a 'cram down'
...
1. The amount of a creditor's claim is the amount allowed by the court, and _the court accepts management valuations_
1. The court may understate the amount of the claim by failing to provide appropriate interest
