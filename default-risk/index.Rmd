...
> Suppose a borrower chose _a upper-bar_ in the first best case (the borrower is of the bad type).  Then moral hazard is present is such a borrower chooses _a lower-bar_ in the second best case when offered an unsecured (bank would make zero expected profit if borrower would have chosen _a upper-bar_).
